...
try:
    ...
    input_shapefile = "H:/Agriculture and Energy Tool/Tool/spark-template/data/uploads/extracted/unknown_boundary/Dzongkhag Boundary.shp"
    ...
    # 5. Save as Shapefile
    output_shapefile = "H:/Agriculture and Energy Tool/Tool/spark-template/data/processed/unknown_mask.shp"
