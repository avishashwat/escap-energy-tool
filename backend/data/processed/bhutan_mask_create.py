...
try:
    ...
    input_shapefile = "H:/Agriculture and Energy Tool/New folder/data/uploads/extracted/bhutan_boundary/Dzongkhag Boundary.shp"
    ...
    # 5. Save as Shapefile
    output_shapefile = "H:/Agriculture and Energy Tool/New folder/data/processed/bhutan_mask.shp"
