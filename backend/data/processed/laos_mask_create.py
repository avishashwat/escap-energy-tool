...
try:
    ...
    input_shapefile = "H:/Agriculture and Energy Tool/New folder/data/uploads/extracted/laos_boundary/ADM1_LAO_OCHA.shp"
    ...
    # 5. Save as Shapefile
    output_shapefile = "H:/Agriculture and Energy Tool/New folder/data/processed/laos_mask.shp"
