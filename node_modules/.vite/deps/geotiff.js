...
addDecoder([void 0, 1], () => import("./raw-UKC26CDE.js").then((m) => m.default), false);
...
addDecoder(
  34887,
  () => import("./lerc-L43FSYOD.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
addDecoder(
  5e4,
  () => import("./zstd-W4T3PMEF.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
addDecoder(50001, () => import("./webimage-T4PTOJUP.js").then((m) => m.default), false);
